...
<kbd>Theorem 6.1</kbd> Consider a dissipative polynomial ODEs system. There exists a monomial quadratization  such that the quadratized system is dissipative as well. Furthermore, if the degree of the right-hand side does not exceed $d$, the new variables can be chosen to be of degree at most $d - 1$.
